...
textanalysis is rather fast thanks to Julia, let's take a larger dataset and train an LDA model on macbeth (data from [word2vec.r](https://word2vec.news-r.org)).
